...
Route::put('customers/{customer_id}', 'ApiController@postCustomer');
...
Route::get('reports/{customer_id}', 'ApiController@getReport');
Route::put('reports/{customer_id}', 'ApiController@postReport');
Route::delete('reports/{customer_id}', 'ApiController@deleteReport');
